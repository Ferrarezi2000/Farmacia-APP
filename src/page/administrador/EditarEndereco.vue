        ...
        <md-card>
            ...
            <md-card-content>
                ...
                <md-input-container>
                    ...
                    <md-input v-model="nomeLogado.endereco.logradouro"></md-input>
                </md-input-container>

                <md-input-container>
                    <label>Número</label>
                    <md-input v-model="nomeLogado.endereco.numero"></md-input>
                </md-input-container>

                <md-input-container>
                    <label>Bairro</label>
                    <md-input v-model="nomeLogado.endereco.bairro"></md-input>
                </md-input-container>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            salvar () {
                this.$http.post(C.URL.FARMACIA.EDITAR_ENDERECO + this.nomeLogado.id, this.nomeLogado).then(res => {
